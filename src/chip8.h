...
typedef struct chip8
{
    ...
    char video_buffer[CHIP8_DISPLAY_WIDTH * CHIP8_DISPLAY_HEIGHT];
    uint16_t stack[STACK_SIZE];
} CHIP8;

/**
 * @brief Initializes the Chip 8 interpreter structure with the default data.
 * 
 * @return CHIP8* 
 */
CHIP8* initializeInterpreter(void);
